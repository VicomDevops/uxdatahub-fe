                        ...
                        <div className="card-body">
                            <p className="card-text">
                                ...
                                <p>
                                    ...
                                    société Insight Data pour tout utilisateur du Site (l’"Utilisateur"). Cela concerne toutes les 
                                    informations, commentaires, captures d’écran ou autres ("Données") émis ou reçus par l’Utilisateur 
                                    auprès d’Insight Data. 
                                </p>   
                                <p>
                                    ...
                                    Le fait qu’Insight Data ne se prévale pas à un moment donné de l'une des quelconques dispositions des CGU ne peut être interprété comme valant 
                                ...
                                <p>
                                    Il ne peut utiliser un matériel pouvant être contraire aux restrictions ci-dessus pour les sources. Insight Data offrira toute sa coopération à toute autorité ou organisme chargé de faire 
                                    respecter et appliquer les Lois et règlements et/ou les principes ci-dessus. Toute injonction émanant des tribunaux, autorités et organismes exigeant d’Insight Data qu’elle divulgue 
                                ...
                                <p>
                                    Insight Data d'une part et les Utilisateurs d'autre part sont des parties respectivement indépendantes, chacune agissant en son nom et pour son propre compte, sous réserves des 
                                    strictes prérogatives confiées à Insight Data au titre des CGU.
                                    <br />
                                    Les CGU ne créent aucun lien de subordination, société en participation, entreprise commune, de relations 
                                    employeur/employé ou franchiseur/franchisé entre Insight Data et les Utilisateurs. Les Utilisateurs acceptent les missions en toute indépendance et sont libres dans la réalisation
                                    des Données. 
                                </p>
                                ...
                                <p>
                                    ...
                                    préalable d’Insight Data. 
                                </p>
                                <p>
                                    Aucun droit ou licence ne saurait être attribué sur l’un quelconque de ces éléments sans l’autorisation écrite expresse d’Insight Data. Insight Data se réserve le droit de poursuivre
                                    toute action en contrefaçon de ses droits de propriété intellectuelle. 
                                </p>
                                <h5>Données à caractères personnelles  </h5>    
                                <p>
                                    Insight Data comprend que la protection des données et de la vie privée soit un enjeu pour l’ensemble des internautes visitant le site de la société. Insight Data s’engage, conformément
                                    ...
                                    en tant que personne. Pour en savoir plus, nous vous invitons à lire notre page consacrée à la politique d’Insight Data concernant le respect de la vie privée. 
                                </p>
                                <h5>Responsabilité </h5>    
                                <p>
                                    Insight Data se réserve le droit, à tout moment, de modifier ou interrompre son Site et ses missions sans que sa responsabilité ne puisse être engagée. 
                                    L’Utilisateur devra disposer des compétences et du matériel requis pour effectuer les missions. Insight Data ne saurait être tenu responsable en cas de mauvais 
                                    ...
                                    propres à l’utilisation d’internet, en particulier les délais de transmission, erreurs techniques et risque de piratage. Insight Data n’est pas responsable des coûts téléphoniques
                                    et/ou coûts de transmission des Données et/ou toutes autres informations téléchargées. Insight Data n’assume aucune responsabilité pour les dommages qui pourraient être causés 
                                    au matériel informatique des Utilisateurs. 
                                    <br />
                                    La responsabilité d’Insight Data ne saurait être engagée en cas d'inexécution d’une mission du fait d'un tiers, en cas de force majeure
                                ...
                                <p>
                                    ...
                                    « tel quel » en l’état. Insight Data ne donne pas d’avis ni de garantie quant au contenu du Site. De plus, Insight Data décline toute responsabilité face à toute garantie formelle ou 
                                    ...
                                    <br />
                                    Insight Data ne garantit pas que : 
                                    <br />
                                ...
                                <p>
                                    La responsabilité juridique civile, contractuelle ou autre d’Insight Data ne sera en aucun cas engagée vis-à-vis des utilisateurs, pour tout préjudice, pour la perte de profit, 
                                    ...
                                    d’Insight Data. Ceci y compris les dommages accessoires particuliers ou autres dommages indirects.
                                    <br />
                                ...
                                <h5>Indemnisation de Insight Data du fait des préjudices de votre fait  </h5> 
                                <p>
                                    Vous acceptez d’indemniser la société Insight Data de la défendre et de l’exonérer de toute responsabilité y compris pour ses employés, cadres, mandataires, agents et représentants
                                ...
                                <h5>Relations avec Insight Data </h5> 
                                <p>
                                    ...
                                    élément que vous envoyez à Insight Data sous forme de courrier électronique ou autrement, y compris toutes les données, questions, commentaires, suggestions ou autres,
                                ...
                                <p>
                                    ...
                                    peut être utiliser librement par Insight Data ou ses sociétés affiliées ou ses partenaires, y compris, sans toutefois s’y limiter, par reproduction, divulgation, transmission, 
                                    publication et diffusion. De plus, Insight Data peut à son gré utiliser toute idée, tout concept, tout savoir-faire ou toute technique qui serait incluse dans n’importe quelle 
                                    ...
                                    entre autres, pour le développement, la modification, la fabrication et la commercialisation de produits et services Insight Data à l’aide des dites informations recueillies. 
                                </p>
                                <h5>Liens hypertextes - Cookies  </h5> 
                                <p>
                                    Lors de la consultation du site https://Insight Data.fr, des cookies sont déposés sur votre ordinateur, votre tablette ou votre smartphone. La page politique de cookies 
                                ...
                                <p>
                                    Le Site peut contenir des liens vers d’autres sites Web qui ne sont pas en maintenance par Insight Data ou qui contiennent des informations sur de produits ou services tiers.
                                    Insight Data ne vérifie pas les pratiques juridiques, commerciales, les informations ou autres de ces tiers qui sont indépendants d’Insight Data et ne donne aucune garantie en leur nom.  
                                </p>
                                <p>
                                    La mise à disposition de tout lien ou le renvoi vers tout lien tiers ne sera jamais synonyme de la prise en charge de la responsabilité de ces tiers par Insight Data sur les contenus de ces sites tiers.
                                    ...
                                    pas nécessairement celles d’Insight Data et chaque utilisateur doit garder son libre arbitre.   
                                </p>
                                <h5>Programmes promotionnels  </h5> 
                                <p>
                                    Dans le cadre d’un effort de prospection, Insight Data pourra offrir ou organiser des panels, tirages, récompenses, programmes de points de fidélité ou autres promotions ou programmes 
                                    ...
                                    au moment où vous accéderez auxdits services. Insight Data se réserve le droit de modifier ou d’annuler, à tout moment et sans préavis les récompenses et avantages attribués par le programme. 
                                </p>
                                ...
                                <p>
                                    ...
                                    les missions proposées par Insight Data, dès lors que le compte Utilisateur atteint un montant de 500 euros. Si l’Utilisateur réside à l’étranger, il devra s’assurer que son statut soit 
                                    compatible avec celui exigé par Insight Data. Pour toute question sur votre statut, n’hésitez pas à contacter par email à contact_insightdata@2m-advisory.fr 
                                    <br />
                                    ...
                                    des missions. Insight Data se réserve le droit de suspendre temporairement ou définitivement le compte de tout Utilisateur. L’Utilisateur reconnait et accepte de garder confidentiel l’identifiant et le mot de passe
                                    ...
                                    consentement écrit et préalable d’Insight Data L’Utilisateur est seul responsable de son compte et de l’utilisation qu’il en fait.  
                                </p>
                                <p>
                                    Les missions disponibles sont consultables sur le Site. Les missions sont régulièrement mises à jour et Insight Data se réserve la possibilité de modifier la liste et le contenu des missions à tout moment. 
                                    ...
                                    dans le cadre d’une mission. Insight Data ne peut être tenue pour responsable de l’achat par un Utilisateur d’un produit réalisé en contradiction avec les termes et conditions
                                    d’une mission.                                
                                </p>
                                <p>
                                    ...
                                    devra alors transférer ses Données à Insight Data en suivant les instructions figurant sur le Site. 
                                    <br />
                                    ...
                                    confidentielles et à ne pas les divulguer sans l’accord préalable d’Insight Data. L'utilisateur s'engage à supprimer de son appareil l'application testée dans le cas où celle-ci ne 
                                    serait pas encore publique sur les stores d'application. L’Utilisateur s’engage à ne transmettre à Insight Data que des Données libres de tout droit et pour lesquelles l’Utilisateur est le seul
                                    propriétaire des droits d’auteurs, de sorte qu’Insight Data soit le seul bénéficiaire et propriétaire des Données, étant entendu qu’Insight Data pourra librement, sous son seul nom, disposer 
                                    des Données, les éditer et/ou les communiquer à tout tiers, en l’état ou retraitées.
                                    <br />
                                     Insight Data se réserve le droit de refuser toutes Données de l’Utilisateur qu’il considèrerait mal exécutées 
                                    ...
                                    à Insight Data de nouvelles Données en conformité avec les attentes d’Insight Data.                                 
                                    </p>
                                    <p>
                                        Le transfert des Données de l’Utilisateur vers Insight Data emporte cession des droits d’auteurs, ce que reconnait expressément l’Utilisateur.
                                        <br />
                                        ...
                                        Sauf convention contraire, les données audio et vidéo de l’Utilisateur ne pourront en aucun cas être utilisées par le propriétaire du site et/ou Insight Data sauf à des usages 
                                    ...
                                    <p>
                                        ...
                                        fixé à 28 (vingt huit) Euros. Tant que ce seuil ne sera pas atteint, Insight Data ne sera pas tenu de verser les sommes qui seront alors comptabilisées sur le compte du testeur.
